...
export function LandingPricing() {
  return (
    <div className="grid gap-4 sm:grid-cols-2">
      <div className="rounded-xl border border-slate-800 bg-slate-950/70 p-6 transition hover:border-sky-600 hover:shadow-lg hover:shadow-brand-500/10">
        <div className="text-xs uppercase tracking-wide text-slate-400">Pro</div>
        <div className="mt-1 text-3xl font-bold text-brand-300">$4/mo</div>
        <p className="mt-2 text-sm text-slate-300">Solo builders who need unlimited maps.</p>
        <ul className="mt-4 space-y-2 text-sm text-slate-400">
          <li className="flex items-center gap-2">
            <span className="text-brand-400">✓</span> Unlimited maps
          </li>
          <li className="flex items-center gap-2">
            <span className="text-brand-400">✓</span> Unlimited nodes
          </li>
          <li className="flex items-center gap-2">
            <span className="text-brand-400">✓</span> Export & embed
          </li>
          <li className="flex items-center gap-2">
        ...
        <Link
          href="/"
          className="mt-4 block w-full rounded-lg bg-brand-500 px-4 py-2.5 text-center text-sm font-semibold text-slate-950 transition hover:bg-brand-400"
        >
          Start Pro Plan
        </Link>
      </div>

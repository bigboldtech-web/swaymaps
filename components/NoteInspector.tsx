                    ...
                    <div key={field.id} className={`group rounded-lg border transition-all ${isLight ? "border-slate-200 bg-white hover:border-slate-300 hover:shadow-sm" : "border-slate-700/30 bg-slate-800/20 hover:border-slate-600/40"}`}>
                      ...
                      <div className={`flex items-center gap-1 px-2 py-1.5 ${isLight ? "border-b border-slate-100" : "border-b border-slate-700/20"}`}>
                        ...
                        <div className="flex items-center gap-0.5">
                          <button onClick={() => moveField(-1)} disabled={idx === 0} className={`p-1 rounded transition ${idx === 0 ? "opacity-20 cursor-not-allowed" : isLight ? "text-slate-400 hover:text-slate-700 hover:bg-slate-100" : "text-slate-500 hover:text-slate-200 hover:bg-slate-700/50"}`} title="Move up">
                          ...
                          <button onClick={() => moveField(1)} disabled={idx === (metaDraft.customFields ?? []).length - 1} className={`p-1 rounded transition ${idx === (metaDraft.customFields ?? []).length - 1 ? "opacity-20 cursor-not-allowed" : isLight ? "text-slate-400 hover:text-slate-700 hover:bg-slate-100" : "text-slate-500 hover:text-slate-200 hover:bg-slate-700/50"}`} title="Move down">
                        ...
                        {/* Delete */}
                        <button onClick={removeField} className={`p-1 rounded transition ${isLight ? "text-slate-400 hover:text-red-500 hover:bg-red-50" : "text-slate-500 hover:text-red-400 hover:bg-red-500/10"}`} title="Delete property">

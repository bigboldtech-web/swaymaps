                    ...
                    <div key={field.id} className={`group rounded-lg border transition-all ${isLight ? "border-slate-200 bg-white hover:border-slate-300 hover:shadow-sm" : "border-slate-700/30 bg-slate-800/20 hover:border-slate-600/40"}`}>
                      ...
                      <div className={`flex items-center gap-1 px-2 py-1.5 ${isLight ? "border-b border-slate-100" : "border-b border-slate-700/20"}`}>
                        ...
                        <div className="flex items-center gap-0.5 flex-shrink-0">
                          <button
                            type="button"
                            onMouseDown={(e) => { e.preventDefault(); e.stopPropagation(); if (idx > 0) moveField(-1); }}
                            className={`p-1 rounded transition ${idx === 0 ? "opacity-20 cursor-not-allowed" : isLight ? "text-slate-400 hover:text-slate-700 hover:bg-slate-100 active:bg-slate-200" : "text-slate-500 hover:text-slate-200 hover:bg-slate-700/50 active:bg-slate-600/50"}`}
                            title="Move up"
                          >
                          ...
                          <button
                            type="button"
                            onMouseDown={(e) => { e.preventDefault(); e.stopPropagation(); if (idx < (metaDraft.customFields ?? []).length - 1) moveField(1); }}
                            className={`p-1 rounded transition ${idx === (metaDraft.customFields ?? []).length - 1 ? "opacity-20 cursor-not-allowed" : isLight ? "text-slate-400 hover:text-slate-700 hover:bg-slate-100 active:bg-slate-200" : "text-slate-500 hover:text-slate-200 hover:bg-slate-700/50 active:bg-slate-600/50"}`}
                            title="Move down"
                          >
                          ...
                          <button
                            ...
                            className={`p-1 rounded transition ${isLight ? "text-slate-400 hover:text-red-500 hover:bg-red-50" : "text-slate-500 hover:text-red-400 hover:bg-red-500/10"}`}

...
export function SearchModal({ onSelectMap, onClose }: SearchModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-start justify-center bg-black/70 px-4 pt-[15vh]" onClick={onClose}>
      <div
      ...
      >
        <div className="flex items-center gap-3 border-b px-4 py-3" style={{ borderColor: isDark ? "#0f172a" : "#e2e8f0" }}>

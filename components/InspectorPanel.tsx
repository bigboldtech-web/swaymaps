...
const sectionClass = "space-y-1 rounded-lg bg-slate-50 p-3";
const titleClass = "text-sm font-semibold text-slate-700";
  ...
  return (
    <div className="space-y-3">
      <div className={sectionClass}>
        <div className="flex items-center justify-between">
          <div>
            ...
            <div className="text-base font-semibold">{person.roleTitle}</div>
            <div className="text-sm text-slate-600">{person.department}</div>
          </div>
      ...
      <div className={sectionClass}>
        ...
        <p className="text-sm text-slate-700">{person.responsibilities}</p>
      </div>
  ...
  return (
    <div className="space-y-3">
      ...
      <div className={sectionClass}>
        ...
        <p className="text-sm text-slate-700">{process.trigger}</p>
      </div>
  ...
  return (
    <div className="space-y-3">
      ...
      <div className={sectionClass}>
        ...
        <p className="text-sm text-slate-700">{system.usedFor}</p>
      </div>
      ...
      {system.notes && (
        <div className={sectionClass}>
          ...
          <p className="text-sm text-slate-700">{system.notes}</p>
        </div>
      )}
    </div>
  );
...
function EdgeView({
  ...
  return (
    <div className="space-y-3">
      <div className={sectionClass}>
        <div className="text-sm text-slate-700">
          <span className="font-medium">Relation:</span> {edge.relationType}
        </div>
        {edge.label && <div className="text-sm text-slate-600">Label: {edge.label}</div>}
      </div>
...
export default function InspectorPanel({
  ...
  const renderBody = () => {
    ...
    return (
      <div className="flex h-full flex-col items-center justify-center text-center text-sm text-slate-600">
        <div className="text-lg font-semibold text-slate-800">Nothing selected</div>
  ...
  return (
    <aside className="w-[360px] flex-none border-l border-slate-200 bg-white shadow-lg">
      <div className="flex items-center justify-between border-b border-slate-200 px-4 py-3">
        ...
        <button
          onClick={onClose}
          className="rounded-md border border-slate-200 px-2 py-1 text-xs font-semibold text-slate-600 transition hover:border-slate-300 hover:text-slate-800"
        >
          Clear
        </button>
      </div>

          ...
          <div className="max-w-lg space-y-4">
            ...
            <div className="mt-6 space-y-3 text-sm text-slate-400">
              <div className="flex items-center gap-2">
                <span className="text-brand-400">&#10003;</span> Free plan with 3 maps
              </div>
              <div className="flex items-center gap-2">
                <span className="text-brand-400">&#10003;</span> 14-day free trial on Pro & Team
              </div>
              <div className="flex items-center gap-2">
                <span className="text-brand-400">&#10003;</span> Cancel anytime
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="w-full max-w-md">
            ...
            <div className="rounded-2xl border border-slate-700/40 bg-slate-900/80 backdrop-blur-xl p-8">
              ...
              <div className="mt-6 text-center text-sm text-slate-400">
                ...
                <Link href="/auth/signin" className="font-semibold text-brand-400 transition hover:text-brand-300">
                  Sign in
                </Link>
              </div>
            </div>

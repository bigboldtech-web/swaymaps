        ...
        <div className="hidden flex-col justify-center bg-gradient-to-br from-sky-950 via-[#030712] to-indigo-950 px-12 py-12 md:flex">
          <div className="max-w-lg space-y-4">
            ...
            <p className="text-sm leading-relaxed text-slate-400">
              Map your systems, trace dependencies, and ship with confidence. The visual dependency mapping platform trusted by engineering teams.
            </p>
          </div>
        </div>
...
export default function SignInPage() {
  return (
    <Suspense fallback={<div className="flex min-h-screen items-center justify-center bg-[#030712] text-slate-400">Loading...</div>}>
      <SignInForm />
    </Suspense>
  );
}
